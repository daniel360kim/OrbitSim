...
OrbitalObjectBuilder& OrbitalObjectBuilder::setMeanAnomaly(double meanAnomaly)
{
...
void OrbitalObject::printInformation() const
{
    ...
    std::cout << "Argument of periapsis: " << m_argumentOfPeriapsis << std::endl;
    std::cout << "Mean anomaly: " << m_meanAnomaly << std::endl;
