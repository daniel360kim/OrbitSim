...
{
    EarthOrbitViewer::EarthOrbitViewer(uint32_t width, uint32_t height)
        : Scene(width, height)
    {
    ...
    EarthOrbitViewer::~EarthOrbitViewer()
    {
    }

    void EarthOrbitViewer::setTargetOrbit(const std::string &name)
    {
    ...
    void EarthOrbitViewer::OnUpdate(float ts, SimulationTime &simulationTime)
    {
        Walnut::Timer timer;
    ...
    void EarthOrbitViewer::OnUIRender(std::vector<ImFont *> &fonts, SimulationTime &simulationTime)
    {
    ...
    void EarthOrbitViewer::ResizeIfNeeded(uint32_t width, uint32_t height)
    {
    ...
    void EarthOrbitViewer::Draw(SimulationTime &simulationTime)
    {
    ...
    void EarthOrbitViewer::DrawBackground(std::shared_ptr<Image> background)
    {
    ...
    void EarthOrbitViewer::updateSatelliteData(const std::vector<SatelliteData> &data)
    {
        m_Orbits.clear();
        OrbitalObject moon = OrbitalObjectBuilder("Moon", Type::Moon, 7.34767309e22)
                                 .setSemiMajorAxis(384400.0)
                                 ...
                                 .setInclination(5.145)
                                 .setLongitudeOfAscendingNode(125.08)
                                 .setCentralBody(m_Earth->GetCentralBody())
                                 .build();
     ...
     */
    std::vector<std::string> EarthOrbitViewer::getBaseOrbitNames()
    {
    ...
    std::vector<std::string> EarthOrbitViewer::getOrbitGUIItems(std::shared_ptr<Ellipse> orbit)
    {
    ...
    std::vector<std::string> EarthOrbitViewer::getBodyGUIItems(std::shared_ptr<Body> body)
    {
        std::vector<std::string> items;
