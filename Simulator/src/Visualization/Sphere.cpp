...
{
    Sphere::Sphere(double radius, int segments, int rings, const std::string& texturePath, int textureWidth, int textureHeight)
        : m_radius(radius), m_segments(segments), m_rings(rings), m_textureWidth(textureWidth), m_textureHeight(textureHeight)
    {
